...
export const SERVICE_DEMO_IDS = {
  ...
  fulfillmentRuns: {
    ...
    picking: "f0000006-0000-4000-8000-000000000003",
    ordered: "f0000006-0000-4000-8000-000000000004",
    shipped: "f0000006-0000-4000-8000-000000000005",
    closed: "f0000006-0000-4000-8000-000000000006",
    cancelled: "f0000006-0000-4000-8000-000000000007",
  },
  /** Master catalog rows (one per SEED_PART_NUMBERS index). */
  partsCatalog: Array.from({ length: 8 }, (_, i) => {
    const n = String(i + 1).padStart(3, "0");
    return `f0000010-0000-4000-8000-000000000${n}`;
  }),
  /** Counter / phone internal orders (crm_company_id; no portal customer). */
  internalPartsOrders: {
    draft: "f0000011-0000-4000-8000-000000000001",
    submitted: "f0000011-0000-4000-8000-000000000002",
    confirmed: "f0000011-0000-4000-8000-000000000003",
  },
  /** Relational lines for internalPartsOrders + extras (6 lines). */
  partsOrderLines: Array.from({ length: 6 }, (_, i) => {
    const n = String(i + 1).padStart(3, "0");
    return `f0000012-0000-4000-8000-000000000${n}`;
  }),
  /** Extra inventory rows: branch "main" for quick manual testing (3 rows). */
  partsInventoryMainBranch: [
    "f0000003-0000-4000-8000-000000000025",
    "f0000003-0000-4000-8000-000000000026",
    "f0000003-0000-4000-8000-000000000027",
  ],
  fulfillmentEvents: [
  ...
  /** Predictive parts kits (Wave 3C moonshot). */
  predictiveKits: [
    "f0000019-0000-4000-8000-000000000001",
    "f0000019-0000-4000-8000-000000000002",
    "f0000019-0000-4000-8000-000000000003",
    "f0000019-0000-4000-8000-000000000004",
  ],
  /** Voice/photo order IDs (Wave 3A/3B moonshot). */
  voiceOrder: "f0000020-0000-4000-8000-000000000001",
  voiceOrderLines: [
    "f0000020-0000-4000-8000-000000000010",
    "f0000020-0000-4000-8000-000000000011",
  ],
  /** Transfer recommendations (Wave 4A moonshot). */
  transferRecs: [
    "f0000021-0000-4000-8000-000000000001",
    "f0000021-0000-4000-8000-000000000002",
    "f0000021-0000-4000-8000-000000000003",
  ],
  /** Customer parts intelligence (Wave 4C moonshot). */
  customerIntel: [
    "f0000022-0000-4000-8000-000000000001",
    "f0000022-0000-4000-8000-000000000002",
  ],
  /** Auto-replenishment queue entries (Wave 2A moonshot). */
  replenishQueue: [
    "f0000016-0000-4000-8000-000000000001",
    "f0000016-0000-4000-8000-000000000002",
    "f0000016-0000-4000-8000-000000000003",
    "f0000016-0000-4000-8000-000000000004",
    "f0000016-0000-4000-8000-000000000005",
    "f0000016-0000-4000-8000-000000000006",
  ],
  /** Replenishment rules (Wave 2A moonshot). */
  replenishRule: "f0000016-0000-4000-8000-000000000010",
  /** Vendor-part catalog entries (Wave 2B moonshot). */
  vendorPartCatalog: [
    "f0000017-0000-4000-8000-000000000001",
    "f0000017-0000-4000-8000-000000000002",
    "f0000017-0000-4000-8000-000000000003",
    "f0000017-0000-4000-8000-000000000004",
    "f0000017-0000-4000-8000-000000000005",
    "f0000017-0000-4000-8000-000000000006",
    "f0000017-0000-4000-8000-000000000007",
    "f0000017-0000-4000-8000-000000000008",
    "f0000017-0000-4000-8000-000000000009",
    "f0000017-0000-4000-8000-000000000010",
  ],
  /** Order events audit trail (Wave 2C moonshot). */
  orderEvents: [
    "f0000018-0000-4000-8000-000000000001",
    "f0000018-0000-4000-8000-000000000002",
    "f0000018-0000-4000-8000-000000000003",
    "f0000018-0000-4000-8000-000000000004",
    "f0000018-0000-4000-8000-000000000005",
    "f0000018-0000-4000-8000-000000000006",
    "f0000018-0000-4000-8000-000000000007",
    "f0000018-0000-4000-8000-000000000008",
    "f0000018-0000-4000-8000-000000000009",
    "f0000018-0000-4000-8000-000000000010",
    "f0000018-0000-4000-8000-000000000011",
    "f0000018-0000-4000-8000-000000000012",
  ],
  /** Parts cross-references / interchangeability graph (Wave 1C moonshot). */
  crossReferences: [
    "f0000015-0000-4000-8000-000000000001",
    "f0000015-0000-4000-8000-000000000002",
    "f0000015-0000-4000-8000-000000000003",
    "f0000015-0000-4000-8000-000000000004",
    "f0000015-0000-4000-8000-000000000005",
    "f0000015-0000-4000-8000-000000000006",
    "f0000015-0000-4000-8000-000000000007",
    "f0000015-0000-4000-8000-000000000008",
  ],
  /** Demand forecast rows (Wave 1B moonshot) — 3 months × 3 branches × 8 parts = 72 max. */
  demandForecasts: Array.from({ length: 72 }, (_, i) => {
    const n = String(i + 1).padStart(3, "0");
    return `f0000014-0000-4000-8000-000000000${n}`;
  }),
  /** Reorder intelligence profiles (Wave 1A moonshot). */
  reorderProfiles: Array.from({ length: 27 }, (_, i) => {
    const n = String(i + 1).padStart(3, "0");
    return `f0000013-0000-4000-8000-000000000${n}`;
  }),
