...
export function AppLayout({
  ...
  // SalesShell. Legacy QB paths still redirect via App.tsx (the
  // RedirectPreserveSearch mount) but the back-to-floor chip
  // suppression keys off the canonical /sales/quotes route now.
