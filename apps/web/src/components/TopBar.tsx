...
const BREADCRUMB_LABELS: Record<string, string> = {
  ...
  "/qrm/voice-inbox": "Voice Capture Inbox",
  "/qrm/deals": "Deals",
  ...
  "/owner": "Owner Cockpit",
  "/owner/margin-exceptions": "Margin Exceptions",
  ...
  "/qrm/activities/templates": "Templates",
...
const QUICK_ACTION_MAP: Record<string, QuickAction | null> = {
  ...
  "/qrm/voice-inbox": { label: "Voice inbox", route: "/qrm/voice-inbox" },
  ...
  "/owner": { label: "Margin Exceptions", route: "/owner/margin-exceptions" },
  "/owner/margin-exceptions": { label: "Owner Cockpit", route: "/owner" },
