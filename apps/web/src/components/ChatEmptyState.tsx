      ...
      <div className="flex flex-wrap gap-2 justify-center max-w-lg mt-1">
        {SUGGESTIONS.map((suggestion) => (
          <button
            ...
            className="rounded-full border border-border bg-card px-4 py-1.5 text-sm text-foreground hover:border-qep-orange hover:text-qep-orange transition-colors duration-150"
          >
            {suggestion}
          </button>
        ))}
