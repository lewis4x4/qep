...
import type { CrmVoiceCaptureTimelineSignals } from "../lib/voice-capture-activity-metadata";
import {
...
interface CrmVoiceCaptureSignalBlockProps {
  signals: CrmVoiceCaptureTimelineSignals;
  className?: string;
}

export function CrmVoiceCaptureSignalBlock({ signals, className }: CrmVoiceCaptureSignalBlockProps) {
