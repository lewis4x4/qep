import type { CrmWeightedDeal } from "../lib/types";
import { getDealSignalState } from "../lib/deal-signals";

interface CrmPipelineManagerMetricsProps {
  deals: CrmWeightedDeal[];
}
...
export function CrmPipelineManagerMetrics({ deals }: CrmPipelineManagerMetricsProps) {
