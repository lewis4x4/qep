...
import type { CrmCustomField, CrmRecordType } from "../lib/types";

interface CrmCustomFieldsCardProps {
...
function normalizeInputValue(field: CrmCustomField, raw: string | boolean): unknown {
...
function displayInputValue(field: CrmCustomField, value: unknown): string {
...
export function CrmCustomFieldsCard({
  recordType,
  recordId,
  canManageDefinitions,
}: CrmCustomFieldsCardProps) {
