...
// Owner answer SA6: reps may build a quote for a typed prospect. A CRM link is
// still preferred, but a real typed name/company is enough to save the draft;
// the server creates qrm_prospects only when the quote is actually sent.
