  ...
  return (
    <div className="relative rounded-2xl bg-[hsl(var(--card))] border border-white/[0.06] overflow-hidden transition-all duration-150 hover:border-white/20 hover:shadow-lg hover:shadow-black/20">
      ...
      >
        ...
        <div className="px-3.5 pt-3.5 pb-0">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2.5 mt-1.5 text-[11px] text-muted-foreground font-medium">
                {customer.city && (
        ...
        <div className="px-3.5 pt-3 pb-0 flex items-center gap-3">
          ...
          {customer.open_deals > 0 && (
            <span className="text-[10px] font-bold text-qep-orange-accessible uppercase tracking-[0.04em] flex items-center gap-1">
      ...
      <div className="flex border-t border-white/[0.06] bg-foreground/[0.02] mt-3">
        <div className="flex-1 flex items-center gap-1.5 px-3.5 py-2.5 text-[11px] text-muted-foreground font-semibold">
        ...
        {customer.primary_contact_phone && (
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 border-l border-white/[0.06] text-qep-orange-accessible text-[11px] font-bold hover:bg-foreground/[0.04] transition-colors"
          >
...
function StatCell({
  ...
  return (
    ...
    >
      ...
      <p className="text-[9px] text-muted-foreground uppercase tracking-[0.06em] font-bold mt-0.5">
        {label}
      </p>
    </div>
  );
