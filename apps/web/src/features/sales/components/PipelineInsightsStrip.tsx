...
function InsightCard({
  ...
  return (
    <button
      ...
      aria-pressed={insight.filterKey !== null ? isActive : undefined}
      aria-label={`${insight.label}: ${insight.value}. ${insight.subtitle}`}
      className={`group snap-start shrink-0 w-[148px] min-h-[44px] text-left rounded-[14px] border px-3 py-2.5 transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-qep-orange ${
        isActive
