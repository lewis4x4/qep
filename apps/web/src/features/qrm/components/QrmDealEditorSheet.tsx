...
import { getCrmCompany, getCrmContact, listCrmCompanies, listCrmContacts, listCrmDealStages } from "../lib/qrm-api";
import { toDateTimeLocalValue, toIsoOrNull } from "../lib/deal-date";
import { createCrmDealViaRouter, patchCrmDealViaRouter } from "../lib/qrm-router-api";
import type { QrmRepSafeDeal } from "../lib/types";

interface QrmDealEditorSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  deal?: QrmRepSafeDeal | null;
  onSaved?: (deal: QrmRepSafeDeal) => void;
  onArchived?: () => void;
}

export function QrmDealEditorSheet({
  open,
  onOpenChange,
  deal,
  onSaved,
  onArchived,
}: QrmDealEditorSheetProps) {
