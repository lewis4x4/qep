...
import type { QrmCompanyHierarchy } from "../lib/types";

interface QrmCompanyHierarchyCardProps {
  hierarchy: QrmCompanyHierarchy;
  companyId: string;
}
...
export function QrmCompanyHierarchyCard({ hierarchy, companyId }: QrmCompanyHierarchyCardProps) {
  return (
