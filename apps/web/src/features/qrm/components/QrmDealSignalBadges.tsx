...
import type { QrmRepSafeDeal, QrmWeightedDeal } from "../lib/types";
import { getDealSignalState } from "../lib/deal-signals";

type DealSignalInput = Pick<QrmRepSafeDeal, "nextFollowUpAt" | "lastActivityAt" | "createdAt"> |
  Pick<QrmWeightedDeal, "nextFollowUpAt" | "lastActivityAt" | "createdAt">;

interface QrmDealSignalBadgesProps {
  deal: DealSignalInput;
}

export function QrmDealSignalBadges({ deal }: QrmDealSignalBadgesProps) {
