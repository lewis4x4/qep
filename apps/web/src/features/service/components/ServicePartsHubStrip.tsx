...
export function ServicePartsHubStrip({ jobId, fulfillmentRunId }: Props) {
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-amber-600/25 bg-amber-500/[0.06] px-3 py-2 dark:border-amber-500/20 dark:bg-amber-500/[0.08]">
      <span className="text-[10px] font-semibold uppercase tracking-wide text-amber-900/90 dark:text-amber-200/90">
        Parts hub
      </span>
      <Link
        to={`/service/parts`}
