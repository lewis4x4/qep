...
export interface AutoTriagePipelineDependencies {
...
const defaultDependencies: AutoTriagePipelineDependencies = {
  createAdminClient: defaultCreateAdminClient,
  isServiceRoleCaller,
};

export async function handleAutoTriagePipeline(
  req: Request,
  dependencies: Partial<AutoTriagePipelineDependencies> = {},
): Promise<Response> {
