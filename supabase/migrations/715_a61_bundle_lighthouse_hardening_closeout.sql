...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%715_a61_bundle_lighthouse_hardening_closeout.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'IRON_WIZARD_DECOMPOSITION_PLAN §7') ||
      ...
      ' | supabase/migrations/715_a61_bundle_lighthouse_hardening_closeout.sql'
  END,
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '715_a61_bundle_lighthouse_hardening_closeout.sql',
