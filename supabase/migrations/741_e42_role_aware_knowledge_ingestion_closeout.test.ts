...
const closeoutSql = readText("supabase", "migrations", "741_e42_role_aware_knowledge_ingestion_closeout.sql");
...
describe("741_e42_role_aware_knowledge_ingestion_closeout.sql contract", () => {
