...
begin
  ...
  loop
    if to_regclass('public.' || t) is null then
      raise notice 'realtime publication: table public.% does not exist, skipping', t;
      continue;
    end if;
...
-- alter publication supabase_realtime drop table public.crm_equipment;
