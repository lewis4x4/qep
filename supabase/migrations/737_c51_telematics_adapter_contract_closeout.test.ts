...
const closeoutSql = readText("supabase", "migrations", "737_c51_telematics_adapter_contract_closeout.sql");
...
describe("737_c51_telematics_adapter_contract_closeout.sql contract", () => {
