...
const closeoutSql = readText("supabase", "migrations", "755_f25_decisions_web_fallback_closeout.sql");
...
describe("755_f25_decisions_web_fallback_closeout.sql contract", () => {
