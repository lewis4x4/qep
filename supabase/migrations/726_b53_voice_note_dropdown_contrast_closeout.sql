...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%726_b53_voice_note_dropdown_contrast_closeout.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP-OMI-CONSOLIDATED-BUILD-PLAN.md HF-2') ||
      ...
      ' | supabase/migrations/726_b53_voice_note_dropdown_contrast_closeout.sql'
  END,
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '726_b53_voice_note_dropdown_contrast_closeout.sql',
