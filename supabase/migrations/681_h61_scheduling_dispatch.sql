...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%supabase/migrations/681_h61_scheduling_dispatch.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_SERVICE_ROADMAP_ALIGNMENT_2026-05-29.md Appendix A H6') ||
      ' | supabase/migrations/681_h61_scheduling_dispatch.sql' ||
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '681_h61_scheduling_dispatch.sql',
