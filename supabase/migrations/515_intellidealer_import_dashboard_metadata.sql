-- ============================================================================
-- Migration 515: expose IntelliDealer import run metadata to admin dashboard
--
-- Browser upload previews are ledger rows with metadata.preview_only = true.
-- The admin UI needs that flag so operational readiness can continue to point
-- at the latest staged/committed production import while still listing preview
-- audits in recent run history.
-- ============================================================================
