...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%supabase/migrations/670_g91_cores_returns_warranty_parts.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_PHASE3_PARTS_BLUEPRINT_2026-05-26.md §1.9, §1.10, §1.11') ||
      ' | supabase/migrations/670_g91_cores_returns_warranty_parts.sql'
  END,
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '670_g91_cores_returns_warranty_parts.sql',
