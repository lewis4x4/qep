...
const closeoutSql = readText("supabase", "migrations", "725_b52_customer_attach_search_closeout.sql");
...
describe("725_b52_customer_attach_search_closeout.sql contract", () => {
