...
const closeoutSql = readText("supabase", "migrations", "725_b14_action_naming_clarification_closeout.sql");
...
describe("725_b14_action_naming_clarification_closeout.sql contract", () => {
