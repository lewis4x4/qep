...
const migrationPath = join(
  ...
  "supabase",
  "migrations",
  "682_f28_agent_progress_comments_closeout.sql",
);

const sql = readFileSync(migrationPath, "utf8");
const compactSql = sql.replace(/\s+/g, " ").toLowerCase();

describe("682_f28_agent_progress_comments_closeout.sql contract", () => {
  ...
  it("links the closeout to dispatcher and workflow evidence", () => {
    ...
    expect(compactSql).toContain("682_f28_agent_progress_comments_closeout.sql");
