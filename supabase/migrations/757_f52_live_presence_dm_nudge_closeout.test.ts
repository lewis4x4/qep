...
const closeoutSql = readText("supabase", "migrations", "757_f52_live_presence_dm_nudge_closeout.sql");
...
const f15Closeout = readText("supabase", "migrations", "744_f15_brian_triage_queue_closeout.sql");
const f25Closeout = readText("supabase", "migrations", "748_f25_decisions_web_fallback_closeout.sql");
...
describe("757_f52_live_presence_dm_nudge_closeout.sql contract", () => {
