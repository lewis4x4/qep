...
const closeoutSql = readText("supabase", "migrations", "747_f24_voice_memo_answer_pipeline_closeout.sql");
...
describe("747_f24_voice_memo_answer_pipeline_closeout.sql contract", () => {
