...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%696_h15_reveal_gps_manual_fallback.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_SERVICE_ROADMAP_ALIGNMENT_2026-05-29.md Section 1.5, Section 5 ADD (Verizon Reveal)') ||
      ' | supabase/migrations/696_h15_reveal_gps_manual_fallback.sql' ||
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '696_h15_reveal_gps_manual_fallback.sql',
