...
const closeoutSql = readMigration("717_a78_price_lock_customer_attribute_closeout.sql");
...
describe("717_a78_price_lock_customer_attribute_closeout.sql contract", () => {
