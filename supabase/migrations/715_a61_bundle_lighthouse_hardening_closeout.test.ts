...
const closeoutSql = readText("supabase", "migrations", "715_a61_bundle_lighthouse_hardening_closeout.sql");
...
describe("715_a61_bundle_lighthouse_hardening_closeout.sql contract", () => {
