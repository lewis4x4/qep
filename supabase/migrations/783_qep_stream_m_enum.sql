-- ============================================================================
-- Migration 783: add 'M' (Revenue Convergence) to qep_roadmap_stream
...
-- 2026-07-08); drafts formerly at docs/reviews/drafts/stream-m-seed.sql.
-- Safety envelope: append-only; adds enum label 'M' only.
-- ============================================================================

ALTER TYPE qep_roadmap_stream ADD VALUE IF NOT EXISTS 'M' AFTER 'L';

-- Final stream map after Stream M promotion.
