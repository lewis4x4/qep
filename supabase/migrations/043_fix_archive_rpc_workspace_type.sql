-- Fix archive RPC functions:
-- 1. v_workspace_id was declared as uuid but crm tables use text
-- 2. archive_crm_deal referenced sequence_enrollments.workspace_id which does not exist
