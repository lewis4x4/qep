...
const closeoutSql = readText("supabase", "migrations", "726_b53_voice_note_dropdown_contrast_closeout.sql");
...
describe("726_b53_voice_note_dropdown_contrast_closeout.sql contract", () => {
