...
const closeoutSql = readText("supabase", "migrations", "752_f41_precedent_similarity_matching_closeout.sql");
...
describe("752_f41_precedent_similarity_matching_closeout.sql contract", () => {
