...
const closeoutSql = readText("supabase", "migrations", "730_b57_role_scoped_home_route_closeout.sql");
...
describe("730_b57_role_scoped_home_route_closeout.sql contract", () => {
