-- Extend retrieve_document_evidence to also search crm_embeddings.
-- CRM semantic hits are unioned with document hits so the chat function
-- receives a single ranked evidence list from both pipelines.
