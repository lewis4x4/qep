...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%719_a58_save_draft_reason_logging.sql%'
      THEN evidence_link
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '719_a58_save_draft_reason_logging.sql',
    ...
    'implementation_evidence', jsonb_build_array(
      'supabase/migrations/719_a58_save_draft_reason_logging.sql widens quote_packages_status_check for draft_low_margin',
