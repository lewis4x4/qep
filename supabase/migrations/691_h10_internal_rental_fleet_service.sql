...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%691_h10_internal_rental_fleet_service.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_SERVICE_ROADMAP_ALIGNMENT_2026-05-29.md Appendix A H10') ||
      ' | supabase/migrations/691_h10_internal_rental_fleet_service.sql' ||
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '691_h10_internal_rental_fleet_service.sql',
