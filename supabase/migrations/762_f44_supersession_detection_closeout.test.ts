...
const closeoutSql = readText("supabase", "migrations", "762_f44_supersession_detection_closeout.sql");
...
describe("762_f44_supersession_detection_closeout.sql contract", () => {
