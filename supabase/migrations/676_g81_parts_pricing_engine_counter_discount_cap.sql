...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%supabase/migrations/676_g81_parts_pricing_engine_counter_discount_cap.sql%'
      THEN evidence_link
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '676_g81_parts_pricing_engine_counter_discount_cap.sql',
