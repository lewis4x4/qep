...
const closeoutSql = readText("supabase", "migrations", "751_f33_authorize_two_party_signing_closeout.sql");
...
describe("751_f33_authorize_two_party_signing_closeout.sql contract", () => {
