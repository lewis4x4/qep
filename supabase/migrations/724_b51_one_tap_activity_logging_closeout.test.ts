...
const closeoutSql = readText("supabase", "migrations", "724_b51_one_tap_activity_logging_closeout.sql");
...
describe("724_b51_one_tap_activity_logging_closeout.sql contract", () => {
