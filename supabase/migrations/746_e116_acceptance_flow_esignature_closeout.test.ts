...
const closeoutSql = readText("supabase", "migrations", "746_e116_acceptance_flow_esignature_closeout.sql");
...
const a35Closeout = readText("supabase", "migrations", "711_a35_branded_acceptance_flow_closeout.sql");
...
describe("746_e116_acceptance_flow_esignature_closeout.sql contract", () => {
