...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%supabase/migrations/668_g71_parts_quotes_phone_email_capture.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_PHASE3_PARTS_BLUEPRINT_2026-05-26.md §1.6, §2') ||
      ' | supabase/migrations/668_g71_parts_quotes_phone_email_capture.sql'
  END,
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '668_g71_parts_quotes_phone_email_capture.sql',
