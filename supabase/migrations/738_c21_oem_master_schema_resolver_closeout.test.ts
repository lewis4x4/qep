...
const closeoutSql = readMigration("738_c21_oem_master_schema_resolver_closeout.sql");
...
const a71CloseoutSql = readMigration("723_a71_oem_price_sheet_schema_closeout.sql");
...
describe("738_c21_oem_master_schema_resolver_closeout.sql contract", () => {
  ...
  it("cross-references the existing A7.1 schema closeout without widening C2.1 scope", () => {
    ...
    expect(compactCloseout).toContain("supabase/migrations/723_a71_oem_price_sheet_schema_closeout.sql");
  });
});
