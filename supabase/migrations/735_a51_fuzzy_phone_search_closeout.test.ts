...
const closeoutSql = readText("supabase", "migrations", "735_a51_fuzzy_phone_search_closeout.sql");
...
const b52Closeout = readText("supabase", "migrations", "725_b52_customer_attach_search_closeout.sql");
...
describe("735_a51_fuzzy_phone_search_closeout.sql contract", () => {
  it("marks only A5.1 shipped with mission and dependency evidence", () => {
    ...
    expect(compactCloseout).toContain("725_b52_customer_attach_search_closeout.sql");
