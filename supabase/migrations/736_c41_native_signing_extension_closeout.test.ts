...
const closeoutSql = readText("supabase", "migrations", "736_c41_native_signing_extension_closeout.sql");
...
describe("736_c41_native_signing_extension_closeout.sql contract", () => {
