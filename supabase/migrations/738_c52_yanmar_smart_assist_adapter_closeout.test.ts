...
const closeoutSql = readText("supabase", "migrations", "738_c52_yanmar_smart_assist_adapter_closeout.sql");
...
const c51CloseoutSql = readText("supabase", "migrations", "737_c51_telematics_adapter_contract_closeout.sql");
...
describe("738_c52_yanmar_smart_assist_adapter_closeout.sql contract", () => {
  ...
  it("requires C5.1 provider-neutral telematics foundation evidence", () => {
    expect(compactCloseout).toContain("c5.1 shipped in supabase/migrations/737_c51_telematics_adapter_contract_closeout.sql");
