...
--
-- 837 rolls back atomically when CREATE OR REPLACE VIEW attempts to insert
-- open_ar_balance before equipment_summary. Reapply its function and recreate
-- the view so the new column is appended after every existing column.
-- ============================================================================
