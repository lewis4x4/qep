...
const closeoutSql = readText("supabase", "migrations", "740_e21_ui_brand_guide_compliance_closeout.sql");
...
describe("740_e21_ui_brand_guide_compliance_closeout.sql contract", () => {
