...
const migrationPath = join(process.cwd(), "supabase", "migrations", "689_h15_reveal_gps_manual_fallback.sql");
...
describe("689_h15_reveal_gps_manual_fallback.sql contract", () => {
