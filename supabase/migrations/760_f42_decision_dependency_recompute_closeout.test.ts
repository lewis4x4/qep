...
const closeoutSql = readText("supabase", "migrations", "760_f42_decision_dependency_recompute_closeout.sql");
...
describe("760_f42_decision_dependency_recompute_closeout.sql contract", () => {
