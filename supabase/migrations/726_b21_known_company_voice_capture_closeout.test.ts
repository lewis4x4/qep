...
const closeoutSql = readText("supabase", "migrations", "726_b21_known_company_voice_capture_closeout.sql");
...
describe("726_b21_known_company_voice_capture_closeout.sql contract", () => {
