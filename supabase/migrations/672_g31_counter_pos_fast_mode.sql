...
SET ship_state = 'shipped',
    ...
    evidence_link = CASE
      WHEN COALESCE(evidence_link, '') LIKE '%supabase/migrations/672_g31_counter_pos_fast_mode.sql%'
        THEN evidence_link
      ELSE COALESCE(NULLIF(evidence_link, ''), 'QEP_PHASE3_PARTS_BLUEPRINT_2026-05-26.md §2') ||
        ' | supabase/migrations/672_g31_counter_pos_fast_mode.sql'
    END,
    notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '672_g31_counter_pos_fast_mode.sql',
