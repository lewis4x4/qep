...
const closeoutSql = readText("supabase", "migrations", "728_b55_save_draft_back_collision_closeout.sql");
...
describe("728_b55_save_draft_back_collision_closeout.sql contract", () => {
