...
const closeoutSql = readText("supabase", "migrations", "761_f43_owner_delegation_toggles_closeout.sql");
...
describe("761_f43_owner_delegation_toggles_closeout.sql contract", () => {
