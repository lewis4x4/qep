...
SET
  ship_state = 'shipped',
  evidence_link = 'supabase/migrations/673_g41_parts_lookup_engine.sql',
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'evidence',
    jsonb_build_array(
      'supabase/migrations/673_g41_parts_lookup_engine.sql',
      'supabase/functions/ai-parts-lookup/index.ts',
      'supabase/migrations/673_g41_parts_lookup_engine.test.ts'
    ),
    'lookup_paths',
