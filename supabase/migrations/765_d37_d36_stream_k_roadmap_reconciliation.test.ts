...
const closeoutSql = readText(
  "supabase",
  "migrations",
  "765_d37_d36_stream_k_roadmap_reconciliation.sql",
);
...
const pricingEngineSql = readText(
  "supabase",
  "migrations",
  "676_g81_parts_pricing_engine_counter_discount_cap.sql",
);
...
describe("765_d37_d36_stream_k_roadmap_reconciliation.sql contract", () => {
