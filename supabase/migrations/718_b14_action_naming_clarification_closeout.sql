...
SET
  ...
  evidence_link = CASE
    WHEN COALESCE(evidence_link, '') LIKE '%718_b14_action_naming_clarification_closeout.sql%'
      THEN evidence_link
    ELSE COALESCE(NULLIF(evidence_link, ''), 'IRON_FLOOR_AUDIT_2026-05-17.md §3.4') ||
      ...
      ' | supabase/migrations/718_b14_action_naming_clarification_closeout.sql'
  END,
  notes = CASE
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'migration', '718_b14_action_naming_clarification_closeout.sql',
