...
const migrationPath = join(
  ...
  "supabase",
  "migrations",
  "671_phase3_parts_schema_foundation.sql",
);
...
describe("671_phase3_parts_schema_foundation.sql contract", () => {
  ...
  it("marks G1.1 shipped with migration evidence and mission alignment", () => {
    ...
    expect(compactSql).toContain("supabase/migrations/671_phase3_parts_schema_foundation.sql");
