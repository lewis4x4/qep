...
- Combined targeted test run: `26 pass`, `0 fail`.
- Web typecheck: PASS.
...
- Prioritize pages where malformed rows can break operator flows: executive dashboards and high-traffic floor widgets.
