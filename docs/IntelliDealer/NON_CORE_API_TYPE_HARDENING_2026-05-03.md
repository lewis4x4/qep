...
- Combined targeted test run: `12 pass`, `0 fail`.
- Web typecheck: PASS.
...
- Prioritize pages where malformed rows can break operator flows: service agreements, vendor profiles, executive dashboards, and high-traffic floor widgets.
