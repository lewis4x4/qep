...
- Combined targeted test run: `35 pass`, `0 fail`.
- Web typecheck: PASS.
...
- Prioritize pages where malformed rows can break operator flows: remaining executive components and larger Floor role-home/operational widgets.
