...
- Combined targeted test run: `20 pass`, `0 fail`.
- Web typecheck: PASS.
...
- Prioritize pages where malformed rows can break operator flows: vendor profiles, executive dashboards, and high-traffic floor widgets.
