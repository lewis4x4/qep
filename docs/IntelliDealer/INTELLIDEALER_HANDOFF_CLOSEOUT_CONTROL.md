...
| Non-core API type hardening | In progress 2026-05-03 | `NON_CORE_API_TYPE_HARDENING_2026-05-03.md` | Hardened ops payment validation, service labor pricing, QRM approval-center, and service agreement Supabase row shapes with targeted tests and web typecheck. |
...
- Targeted tests passed: `20 pass`, `0 fail`.
